...
export default function CoyoteDetailingPage() {
  ...
  const themeClasses = {
    ...
    cardBg: isDarkMode ? "from-slate-800/90 to-slate-700/60" : "from-white to-gray-50/80",
    ...
    heroText: isDarkMode ? "from-white via-blue-100 to-purple-200" : "from-gray-900 via-blue-800 to-purple-800",
    heroSubtext: isDarkMode ? "text-blue-100/90" : "text-gray-700",
    footerBg: isDarkMode ? "bg-slate-950" : "bg-gray-900",
    inputBg: isDarkMode ? "bg-slate-800 border-slate-600 text-slate-100" : "bg-white border-gray-300 text-gray-900",
    selectBg: isDarkMode ? "bg-slate-800 border-slate-600 text-slate-100" : "bg-white border-gray-300 text-gray-900",
  }
      ...
      <nav
        className={`fixed top-0 w-full z-50 transition-all duration-300 ${
          isScrolled
            ...
            : `${isDarkMode ? "bg-slate-900/80" : "bg-white/80"} backdrop-blur-sm border-b ${themeClasses.navBorder}/50`
        }`}
      >
        ...
        >
          <div className={`${themeClasses.navBg} backdrop-blur-md border-b ${themeClasses.navBorder}`}>
            <div className="px-2 pt-2 pb-3 space-y-1">
              {[
                ...
                <button
                  key={item.id}
                  onClick={() => scrollToSection(item.id)}
                  className={`block px-3 py-2 ${themeClasses.text} hover:text-primary hover:${isDarkMode ? "bg-slate-800/50" : "bg-gray-100"} transition-all duration-300 w-full text-left rounded-md font-medium`}
                >
                  {item.label}
                </button>
              ))}
  ...
  <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
    ...
    >
      ...
      <section id="about" className={`py-16 sm:py-20 ${themeClasses.sectionBg} relative`}>
        <div
          className={`absolute inset-0 ${isDarkMode ? "bg-gradient-to-r from-purple-900/10 to-blue-900/10" : "bg-gradient-to-r from-purple-100/30 to-blue-100/30"}`}
        ></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl font-bold ${themeClasses.text} mb-4`}>About Coyote Detailing</h2>
            <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto text-pretty`}>
              We bring professional car detailing services directly to your location, combining convenience with
              exceptional quality.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="space-y-6 sm:space-y-8">
              <h3 className={`text-xl sm:text-2xl font-semibold ${themeClasses.text} mb-4 sm:mb-6`}>Why Choose Us?</h3>
              {[
                {
                  icon: Sparkles,
                  title: "Premium Quality",
                  description: "Professional-grade products and techniques for exceptional results.",
                },
                {
                  icon: Car,
                  title: "Mobile Convenience",
                  description: "We come to your home or office - no need to travel anywhere.",
                },
                {
                  icon: Shield,
                  title: "Fully Insured",
            ...
            >
              ...
              <p className={`${themeClasses.textSecondary} text-center italic`}>
                "Your vehicle deserves the best care, and we deliver it right to your doorstep."
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Services Section */}
      <section id="services" className={`py-16 sm:py-20 ${themeClasses.sectionAlt}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl font-bold ${themeClasses.text} mb-4`}>Our Services</h2>
            <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto text-pretty`}>
              Comprehensive car detailing services tailored to keep your vehicle looking its absolute best.
            </p>
          </div>
            ...
            {[
              ...
              >
                <CardContent className="p-6 sm:p-8">
                  ...
                  <ul className={`space-y-3 sm:space-y-4 ${themeClasses.textSecondary} mb-6 sm:mb-8`}>
      ...
      <section id="work" className={`py-16 sm:py-20 ${themeClasses.sectionBg}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl font-bold ${themeClasses.text} mb-4`}>Our Work</h2>
            <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto text-pretty`}>
              See the quality and professionalism we bring to every vehicle we service.
            </p>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              { src: "/luxury-car-detailing-1.png", alt: "Professional car detailing in progress" },
              { src: "/luxury-car-detailing-2.png", alt: "Clean shiny car after detailing" },
              { src: "/luxury-car-detailing-3.png", alt: "Professional detailing equipment" },
              { src: "/luxury-car-detailing-4.png", alt: "Mobile detailing service setup" },
              { src: "/luxury-car-detailing-5.png", alt: "Interior cleaning process" },
              { src: "/luxury-car-detailing-6.png", alt: "Sparkling clean car exterior" },
            ].map((item, index) => (
      ...
      <section id="testimonials" className={`py-16 sm:py-20 ${themeClasses.sectionAlt}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl font-bold ${themeClasses.text} mb-4`}>What Our Customers Say</h2>
            <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto text-pretty`}>
            ...
            {[
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className={`${themeClasses.textSecondary} mb-4 italic text-base sm:text-lg leading-relaxed`}>
                    "{testimonial.text}"
                  </p>
                  <div className={`border-t ${isDarkMode ? "border-slate-600" : "border-gray-300"} pt-4`}>
                    <p className={`font-semibold ${themeClasses.text}`}>{testimonial.name}</p>
                    <p className={`text-sm ${themeClasses.textMuted}`}>{testimonial.location}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
      ...
      <section id="booking" className={`py-16 sm:py-20 ${themeClasses.sectionBg}`}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className={`text-3xl sm:text-4xl font-bold ${themeClasses.text} mb-4`}>Book Your Service</h2>
            <p className={`text-lg sm:text-xl ${themeClasses.textSecondary} max-w-3xl mx-auto text-pretty`}>
              Ready to give your car the premium treatment it deserves? Get in touch with us today.
            </p>
          </div>

          <Card className={`border-2 ${themeClasses.cardBorder} shadow-2xl bg-gradient-to-br ${themeClasses.cardBg}`}>
            <CardContent className="p-6 sm:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className={`block text-sm font-medium ${themeClasses.text}`}>
                      Email Address *
                    </label>
                    <Input
                      id="email"
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2">
                    <label htmlFor="phone" className={`block text-sm font-medium ${themeClasses.text}`}>
                      Phone Number *
                    </label>
                    <Input
                      id="phone"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="service" className={`block text-sm font-medium ${themeClasses.text}`}>
                      Service Type *
                    </label>
                    <select
                      id="service"
                    ...
                    >
                      ...
                      <option value="both">Full Service (Interior + Exterior)</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2">
                    <label htmlFor="date" className={`block text-sm font-medium ${themeClasses.text}`}>
                      Preferred Date *
                    </label>
                    <Input
                      id="date"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="time" className={`block text-sm font-medium ${themeClasses.text}`}>
                      Preferred Time *
                    </label>
                    <select
                      id="time"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className={`block text-sm font-medium ${themeClasses.text}`}>
                    Additional Details
                  </label>
                  <Textarea
                    id="message"
      ...
      {/* Footer */}
      <footer className={`${themeClasses.footerBg} text-white py-12 relative overflow-hidden`}>
        <div
          className={`absolute inset-0 ${isDarkMode ? "bg-gradient-to-r from-purple-950/20 to-blue-950/20" : "bg-gradient-to-r from-purple-900/30 to-blue-900/30"}`}
        ></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              ...
              <p className={`text-slate-300 mb-4 leading-relaxed`}>
                Premium mobile car detailing services in the DFW area. We bring professional care directly to you.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-slate-300">
                <div className={`flex items-center gap-3 hover:text-primary transition-colors duration-300`}>
                  <Phone size={16} />
                  <button onClick={handlePhoneCall} className={`hover:text-primary transition-colors`}>
                    469-999-3453
                  </button>
                </div>
                <div className={`flex items-center gap-3 hover:text-primary transition-colors duration-300`}>
                  <Mail size={16} />
                  <button onClick={handleEmailClick} className={`hover:text-primary transition-colors`}>
